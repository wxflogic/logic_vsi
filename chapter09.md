...
我们无法使用前面的方法避免这个问题。在将来所有时间都同一于 $$x$$ 当然是 $$x$$ 的一个性质。而且似乎该性质也并非精细化不够。似乎没有办法能够使它更精确而避免问题。

还有什么要说的呢？一个自然的想法如下。在分裂前 $$B$$ 不是 $$A$$：它只是 $$A$$ 的一部分。但 $$B$$ 现在是一只变形虫，而 $$A$$ 是一个单细胞生物：它没有任何部分是变形虫。因此
