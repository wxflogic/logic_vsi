...
形如“如果 $$a$$，那么不可能不是 $$b$$”的条件句的第二个意思完全不同。我们经常用这种形式的文字来表达 $$b$$ 可以由 $$a$$ 推出这一事实。在说下面这样的话时，我们就是在这个意思上使用该语句：“如果弗雷德打算离婚，那么他不可能不是结了婚的。”我们不是在说，如果弗雷德打算离婚，那么他结了婚这件事是不可改变的。我们是在说，除非你结了婚，否则你不可能离婚。没有一个可能情形使得一个成立而另一个不成立。即，在任何可能的情形中，
