...
现在，$$a\to\Box b$$ 和 $$\Box(a\to b)$$ 意指完全不同的东西。而且第一个无疑不能从第二个推出。仅 $$a\to b$$ 在每个与 $$s$$ 关联的情形都为真这一事实，并不意味着 $$a\to\Box b$$ 在 $$s$$ 中为真。$$a$$ 可以在 $$s$$ 中为真，而 $$$\Box b$$$ 不为真：$$b$$ 和 $$a$$ 在某些关联世界中可以都不为真。或者，给一个具体的反例吧：如果约翰正在离婚，那么他是结了婚的，这是必然真的。但，如果约翰正在离婚，那么他是必然结了婚的，这无疑不为真。